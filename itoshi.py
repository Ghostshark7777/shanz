import requests;ses = requests.Session() 
 ...
 def login(): 
        ...
        / _ \__ ____ _  ___     
       / // / // /  ' \/ _ \      ┌──────────────────────────────┐ 
      /____/\_,_/_/_/_/ .__/      │  {J}Script By Ghostshark7777 {P}  │        
             ___ _/ //_/_ _____   │    {J}Github.com/Ghostshark7777   {P}  │ 
            / _ `/  '_/ // / _ \  └──────────────────────────────┘ 
            \_,_/_/\_/\\_,_/_//_/\n\n\n""") 
 ...
 def menu(): 
      ...
      /____/\_,_/_/_/_/ .__/      │  {J}Script By Ghostshark7777 {P}  │        
         ...
         bas = input(" menu : ") 
         print(f"{P} ─────────────────────────────") 
         if bas in ["1"]:publik(t,c) 
         elif bas in ["2"]:masal(t,c) 
                 ...
                 print(f"\n [{hh}!{P}] contoh pemisah file yang umum di pakai\n contoh = | / • / = / <=> / <> / + ") 
 ...
 def dump_kota(t,c,akun,nama): 
      ...
      /____/\_,_/_/_/_/ .__/      │  {J}Script By Ghostshark7777 {P}  │        
         ...
         except: print(f" [{M}>{P}] akun tidak publik");exit() 
         print(f'\n\n\n [{hh}>{P}] data akun target \n [{hh}>{P}] akun : {hh}{uid}{P}\n [{hh}>{P}] nama : {hh}{name}{P}\n [{hh}>{P}] kota : {hh}{kota}{P}') 
         print(f"{P} ─────────────────────────────") 
 ...
 def get_sekota(t,c,nama): 
         ...
         except Exception as e: print(f" [{M}>{P}] akun tidak publik");exit() 
         tampung = [] 
 ...
 def masal(t,c): 
     ...
     for bz in range(apa): 
             bz +=1 
             pil = input(f'\r masukan akun ke {bz} : ') 
             try: 
                     bas = ses.get(f'https://graph.facebook.com/{pil}?fields=friends.fields(name,id)&access_token={t}',cookies=c).json() 
                     for pi in bas['friends']['data']: 
                           id.append(pi['id']+pm+pi['name']) 
                 ...
                 for cari in data.find_all('table'): 
                         ...
                         if 'mengajukan' in spl: 
                                 ...
                                 if idku in id:continue 
                                         ...
                                         id.append(idku) 
                                         print('\r sedang dump %s id, ctrl+c untuk stop'%(len(id)),end=" ") 
                                         sys.stdout.flush() 
                         elif '>' in spl: 
                                 idsiapa = re.findall('content_owner_id_new.\w+',str(cari)) 
                                 idyou =        idsiapa[0].replace('content_owner_id_new.','') 
 ...
 def dump_unli(nama,t,c): 
      ...
      /____/\_,_/_/_/_/ .__/      │  {J}Script By Ghostshark7777 {P}  │        
            ...
            / _ `/  '_/ // / _ \  └──────────────────────────────┘ 
            \_,_/_/\_/\\_,_/_//_/   selamat datang{K} {nama} {P}""") 
         print(f"\n\n\n [{hh}!{P}]  pilih jenis yang ingin anda dump") 
         print(f" [{hh}1{P}]. dump unli 10008-10005\n [{hh}2{P}]. dump unli 10005-10001\n [{hh}3{P}]. dump unli 10001-100005\n [{hh}4{P}]. dump unli 100005-100001\n [{hh}5{P}]. dump unli 10000009++\n [{hh}6{P}]. setting id manual") 
         afa = input(' menu : ') 
         print(f"{P} ─────────────────────────────") 
         if afa in ['1','01']: 
                 masal_muda(t,c) 
                 ...
                 exit(f" [{K}!{P}] isi yang benar") 
  
  
 ###--- MASAL MANUAL ----### 
 def masal_manual(t,c): 
         id1,id2  = [],[] 
         print(f" [{hh}!{P}] masukan awalan digit, contoh 10005/100001") 
         digit = input(' digit awal : ') 
         if len(digit)>=9: 
                 exit(f" [{K}!{P}] awalan id hanya ada 5 sampai 8 digit") 
         try: 
                 pil = input(" id target  : ") 
                 nam = input(" nama file  : ") 
                         ...
                         for baz in ses.get(f'https://graph.facebook.com/{uid}?fields=friends.fields(name,id)&access_token={t}',cookies=c).json()['friends']['data']: 
                                 if digit in str(baz['id']): 
                                         if baz in id: 
                                                 ...
                                                 print('\r sedang dump %s id'%(len(id)),end="");sys.stdout.flush() 
